...
FINE_TUNED_MODEL_PATH = "iqasimz/qz1.5b"  # Local path to fine-tuned model
...
def load_models():
    ...
    try:
        ...
        # Load base model
        status_text.text("Loading base Qwen-1.5B model...")
...
with col1:
    ...
    st.markdown("• DeepSeek-R1-Distill-Qwen-1.5B (~1.5B params)")
    st.markdown("• General knowledge")

with col2:
    st.markdown("**⚡ Fine-tuned Model**")
    st.markdown("• Fine-tuned DeepSeek-R1-Distill-Qwen-1.5B for nuclear topics")
